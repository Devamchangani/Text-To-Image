...
# st.image("bot.png", caption="Centered Image", width=200, use_column_width=False)
# Add a background image from the web
# st.markdown(
#     """
#     <style>
#     .reportview-container {
#         background: url('https://img.freepik.com/free-vector/abstract-technological-background_23-2148897676.jpg');
...
with col2:
    # st.image(Image.open("bot.png"), width=350)
    st.image("bot.png")
    # st.title(":rainbow[**Text to Image Generator**]",)
